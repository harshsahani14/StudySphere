...
exports.createSubSection = async(req,res)=>{
    try{
        ...
        const uploadedVideo = assetUploadToCloud(video,process.env.cloudDbFolder);
        ...
        const updatedSection = await Section.findByIdAndUpdate(sectionId, { $push:{ subSections : dbVideo._id }}) 
