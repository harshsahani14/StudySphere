...
const NavBar = () => {
  ...
  return (
    <div className=' flex items-center w-full h-[56px] border-b-[1px] border-richblack600 bg-richblack900  gap-[32px] justify-around relative '>
        ...
        <Link to={"/"}>
            <div className=' flex gap-2 justify-start items-center ml-[30px] '>
              <div className='w-[35px] h-[35px] rounded-full bg-[#FFF] flex justify-center items-center  '>
                <p className=' text-richblack900 font-[800] font-inter text-[25px]'>S</p>
              </div>
              <p className='text-[#FFF] text-[22px]  font-[500] mb-1'>StudySphere</p>
            </div>
        </Link>
      
      <div className=' font-inter flex justify-center w-[476px] h-[32px] gap-[30px] items-center '>
            ...
            <div className=' flex gap-2 relative w-[74px] h-[32px] cursor-pointer group items-center'>
                ...
                <MdOutlineKeyboardArrowDown className=' text-richblack5 absolute  right-[-3px]' />
                ...
                <div className=' invisible flex flex-col w-[280px] h-fit group-hover:visible bg-richblack5 absolute top-10 right-[-120px] opacity-0 group-hover:opacity-100 transition-all duration-300 px-[15px]  py-[15px] rounded-md z-50'>
                        <div className=' w-14 h-14 bg-richblack5  top-0 right-[96px] rotate-45 absolute   rounded-sm z-0 '></div>
                        ...
                        {/* Map categories here */}
                      {
                          ...
                          >
                            <SkeletonTheme baseColor="#DBDDEA" highlightColor="#AFB2BF">
                              <Skeleton height={40} 
                                style={ {marginTop:8,
      ...
      <div className=' w-[160px] h-[29.88px] flex flex-end gap-[20px] items-center'>
            ...
            {
              (token!=null ) ? (<div className='flex gap-2 justify-center items-center group cursor-pointer relative z-20 '>
                  ...
                  <div className=' group-hover:visible invisible w-fit h-fit flex flex-col bg-richblack700 rounded-md opacity-0 group-hover:opacity-100 absolute bottom-[-95px] left-[-100px] p-[5px] duration-200  '>
